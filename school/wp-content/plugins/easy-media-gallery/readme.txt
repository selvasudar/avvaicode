...
Tags: gallery, photo gallery, image gallery, responsive gallery, free gallery, slider, photo album, wordpress gallery plugin, slider, photo gallery, images, photo slider, block gallery
...
= 1.3.153 =
* Tweak : Ability to add shortcode using WordPress Block
* Fixed : Many other PHP and CSS clean and optimization

= 1.3.151 =
* Fixed : RTL ( right-to-left ) language issue
* Fixed : Many other PHP and CSS clean and optimization
